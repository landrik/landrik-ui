import{a,j as e,F as T}from"./jsx-runtime-c9381026.js";import{r as D}from"./index-8b3efc3f.js";import{I as n,a as N}from"./Icon-e1e4d749.js";import"./_commonjsHelpers-de833af9.js";import"./styled-components.browser.esm-f7e1e14e.js";const F={title:"Components/Icon",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{name:{control:"select",options:["home","User","Settings","Mail","Heart","Star","Bell","Search"]}}},s={args:{name:"heart",size:"lg"}},t={render:()=>a("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[e(n,{name:"heart",size:"xs"}),e(n,{name:"heart",size:"sm"}),e(n,{name:"heart",size:"md"}),e(n,{name:"heart",size:"lg"}),e(n,{name:"heart",size:"xl"})]})},o={render:()=>a("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[e(n,{name:"heart",size:"md",color:"primary"}),e(n,{name:"heart",size:"md",color:"#ef4444"}),e(n,{name:"heart",size:"md",color:"#3b82f6"}),e(n,{name:"heart",size:"md",color:"#10b981"}),e(n,{name:"heart",size:"md",color:"#f59e0b"}),e(n,{name:"heart",size:"md",color:"#8b5cf6"})]})},i={args:{name:"watch"}},c={args:{name:"watch"}},l={render:()=>{const m=Object.keys(N);return D.useState(m.map(r=>({value:r,label:r}))),a(T,{children:[a("div",{style:{display:"flex",gap:"5px",boxSizing:"border-box",padding:"10px"},children:[e("span",{children:"Total number of Icons"})," "," "," ",e("span",{children:m.length})]}),e("div",{style:{display:"flex",gap:20},children:e("div",{style:{display:"flex",gap:4,width:"1024px",flexDirection:"column"},children:e("ul",{style:{display:"grid",gap:"1rem",margin:"0px",gridTemplateColumns:"repeat(auto-fill, minmax(100px, 1fr))",listStyle:"0",padding:"0px",listStylePosition:"unset"},children:m.map(r=>a("li",{style:{display:"flex",padding:"16px 0px",alignItems:"center",justifyContent:"center",flexDirection:"column",zIndex:10},children:[e(n,{name:r}),r]},r))})})})]})}};var p,d,g;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    name: "heart",
    size: 'lg'
  }
...
}`,...(b=(S=i.parameters)==null?void 0:S.docs)==null?void 0:b.source}}};var v,C,j;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    name: "watch"
  }
}`,...(j=(C=c.parameters)==null?void 0:C.docs)==null?void 0:j.source}}};var w,L,O;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  //args: {name: "watch"}
  render: () => {
...
}`,...(O=(L=l.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};const G=["Default","Sizes","Colors","Interactive","SearchIcon","ListIcon"];export{o as Colors,s as Default,i as Interactive,l as ListIcon,c as SearchIcon,t as Sizes,G as __namedExportsOrder,F as default};
