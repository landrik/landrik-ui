...
`,B=()=>a("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:a("polyline",{points:"15 18 9 12 15 6"})}),L=()=>a("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:a("polyline",{points:"9 18 15 12 9 6"})}),Te=()=>a("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"currentColor",children:a("path",{fillRule:"evenodd",d:"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z",clipRule:"evenodd"})}),I=({images:e,autoPlay:F=!1,autoPlayInterval:j=3e3,showThumbnails:de=!1,showIndicators:pe=!0,showCounter:me=!1,showNavButtons:P=!0,enableFullscreen:T=!1,objectFit:he="cover",height:ge,color:l="#3b82f6",loop:u=!0})=>{var N,W;const[o,c]=k.useState(0),[be,C]=k.useState(!1);k.useEffect(()=>{if(!F)return;const r=setInterval(()=>{y()},j);return()=>clearInterval(r)},[o,F,j]);const y=()=>{o===e.length-1?u&&c(0):c(r=>r+1)},q=()=>{o===0?u&&c(e.length-1):c(r=>r-1)},S=r=>{c(r)},fe=()=>{T&&C(!0)},V=u||o>0,_=u||o<e.length-1;return i($,{children:[i("div",{children:[i(ve,{$height:ge,children:[a(xe,{style:{transform:`translateX(-${o*100}%)`},children:e.map((r,s)=>a(we,{src:r.src,alt:r.alt,$objectFit:he,onClick:fe,style:{cursor:T?"pointer":"default"}},s))}),P&&i($,{children:[a(d,{$position:"left",$color:l,onClick:q,disabled:!V,"aria-label":"Previous image",children:a(B,{})}),a(d,{$position:"right",$color:l,onClick:y,disabled:!_,"aria-label":"Next image",children:a(L,{})})]}),pe&&a(Ce,{children:e.map((r,s)=>a(ye,{$active:s===o,$color:l,onClick:()=>S(s),"aria-label":`Go to slide ${s+1}`},s))}),me&&i($e,{children:[o+1," / ",e.length]})]}),de&&a(ke,{children:e.map((r,s)=>a(Ie,{src:r.src,alt:r.alt,$active:s===o,$color:l,onClick:()=>S(s)},s))})]}),i(Fe,{$visible:be,onClick:()=>C(!1),children:[a(Pe,{onClick:()=>C(!1),"aria-label":"Close fullscreen",children:a(Te,{})}),a(je,{src:(N=e[o])==null?void 0:N.src,alt:(W=e[o])==null?void 0:W.alt,onClick:r=>r.stopPropagation()}),P&&i($,{children:[a(d,{$position:"left",$color:l,onClick:r=>{r.stopPropagation(),q()},disabled:!V,"aria-label":"Previous image",children:a(B,{})}),a(d,{$position:"right",$color:l,onClick:r=>{r.stopPropagation(),y()},disabled:!_,"aria-label":"Next image",children:a(L,{})})]})]})]})};try{I.displayName="Carousel",I.__docgenInfo={description:"",displayName:"Carousel",props:{images:{defaultValue:null,description:"",name:"images",required:!0,type:{name:"CarouselImage[]"}},autoPlay:{defaultValue:{value:"false"},description:"",name:"autoPlay",required:!1,type:{name:"boolean"}},autoPlayInterval:{defaultValue:{value:"3000"},description:"",name:"autoPlayInterval",required:!1,type:{name:"number"}},showThumbnails:{defaultValue:{value:"false"},description:"",name:"showThumbnails",required:!1,type:{name:"boolean"}},showIndicators:{defaultValue:{value:"true"},description:"",name:"showIndicators",required:!1,type:{name:"boolean"}},showCounter:{defaultValue:{value:"false"},description:"",name:"showCounter",required:!1,type:{name:"boolean"}},showNavButtons:{defaultValue:{value:"true"},description:"",name:"showNavButtons",required:!1,type:{name:"boolean"}},enableFullscreen:{defaultValue:{value:"false"},description:"",name:"enableFullscreen",required:!1,type:{name:"boolean"}},objectFit:{defaultValue:{value:"cover"},description:"",name:"objectFit",required:!1,type:{name:"enum",value:[{value:'"cover"'},{value:'"contain"'}]}},height:{defaultValue:null,description:"",name:"height",required:!1,type:{name:"string"}},color:{defaultValue:{value:"#3b82f6"},description:"",name:"color",required:!1,type:{name:"string"}},loop:{defaultValue:{value:"true"},description:"",name:"loop",required:!1,type:{name:"boolean"}}}}}catch{}const Ne={title:"Components/Carousel",component:I,parameters:{layout:"centered"},tags:["autodocs"]},n=[{src:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",alt:"Mountain landscape"},{src:"https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800",alt:"Forest path"},{src:"https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=800",alt:"Flower field"},{src:"https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800",alt:"Beach sunset"}],p={args:{images:n}},m={args:{images:n,showThumbnails:!0}},h={args:{images:n,showCounter:!0}},g={args:{images:n,autoPlay:!0,autoPlayInterval:2e3}},b={args:{images:n,showIndicators:!1}},f={args:{images:n,enableFullscreen:!0,showCounter:!0}},v={args:{images:n,objectFit:"contain"}},x={args:{images:n,loop:!1}},w={args:{images:n,height:"600px",showThumbnails:!0}};var z,M,E;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    images: sampleImages
  }
...
}`,...(J=(Y=g.parameters)==null?void 0:Y.docs)==null?void 0:J.source}}};var K,Q,U;b.parameters={...b.parameters,docs:{...(K=b.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    images: sampleImages,
    showIndicators: false
  }
}`,...(U=(Q=b.parameters)==null?void 0:Q.docs)==null?void 0:U.source}}};var Z,ee,ae;f.parameters={...f.parameters,docs:{...(Z=f.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
    images: sampleImages,
    enableFullscreen: true,
    showCounter: true
  }
}`,...(ae=(ee=f.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};var re,te,oe;v.parameters={...v.parameters,docs:{...(re=v.parameters)==null?void 0:re.docs,source:{originalSource:`{
  args: {
    images: sampleImages,
    objectFit: 'contain'
  }
...
}`,...(ue=(ce=w.parameters)==null?void 0:ce.docs)==null?void 0:ue.source}}};const We=["Default","WithThumbnails","WithCounter","AutoPlay","WithoutIndicators","Fullscreen","ContainMode","NoLoop","CustomHeight"];export{g as AutoPlay,v as ContainMode,w as CustomHeight,p as Default,f as Fullscreen,x as NoLoop,h as WithCounter,m as WithThumbnails,b as WithoutIndicators,We as __namedExportsOrder,Ne as default};
