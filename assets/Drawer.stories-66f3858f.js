import{a as r,F as p,j as n}from"./jsx-runtime-c9381026.js";import{r as i}from"./index-8b3efc3f.js";import{r as Z}from"./index-a38d0dca.js";import{l as f,a as c,r as m}from"./styled-components.browser.esm-f7e1e14e.js";import"./_commonjsHelpers-de833af9.js";const ee=f`from { opacity: 0; } to { opacity: 1; }`,ne=c.div`position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: ${e=>e.theme.zIndices.modal}; animation: ${ee} ${e=>e.theme.transitions.duration.base}; display: ${e=>e.$open?"block":"none"};`,te=f`from { transform: translateX(-100%); } to { transform: translateX(0); }`,re=f`from { transform: translateX(100%); } to { transform: translateX(0); }`,oe=f`from { transform: translateY(-100%); } to { transform: translateY(0); }`,ie=f`from { transform: translateY(100%); } to { transform: translateY(0); }`,le={left:m`top: 0; left: 0; bottom: 0; animation: ${te} ${e=>e.theme.transitions.duration.base} ${e=>e.theme.transitions.timing.easeOut};`,right:m`top: 0; right: 0; bottom: 0; animation: ${re} ${e=>e.theme.transitions.duration.base} ${e=>e.theme.transitions.timing.easeOut};`,top:m`top: 0; left: 0; right: 0; animation: ${oe} ${e=>e.theme.transitions.duration.base} ${e=>e.theme.transitions.timing.easeOut};`,bottom:m`bottom: 0; left: 0; right: 0; animation: ${ie} ${e=>e.theme.transitions.duration.base} ${e=>e.theme.transitions.timing.easeOut};`},ae=(e,t)=>{const a={sm:"320px",md:"448px",lg:"640px",xl:"1024px",full:"100%"};return e==="left"||e==="right"?m`width: ${a[t]}; max-width: 100%;`:m`height: ${a[t]}; max-height: 100%;`},se=c.div`
position: fixed;
...
`,de=c.div`display: flex; align-items: center; justify-content: space-between; padding: ${e=>e.theme.spacing[6]}px; border-bottom: 1px solid ${e=>e.theme.colors.neutral[200]}; flex-shrink: 0;`,pe=c.h2`margin: 0; font-size: ${e=>e.theme.typography.fontSize.xl}; font-weight: ${e=>e.theme.typography.fontWeight.semibold}; color: ${e=>e.theme.colors.neutral[900]};`,ce=c.button`
display: inline-flex;
align-items: center;
...
`,ue=c.div`flex: 1; overflow-y: auto; padding: ${e=>e.theme.spacing[6]}px;`,me=c.div`padding: ${e=>e.theme.spacing[6]}px; border-top: 1px solid ${e=>e.theme.colors.neutral[200]}; flex-shrink: 0;`,he=()=>n("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"currentColor",children:n("path",{fillRule:"evenodd",d:"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z",clipRule:"evenodd"})}),o=({open:e,onClose:t,children:a,placement:s="right",size:h="md",title:l,footer:u,closeOnOverlayClick:d=!0,closeOnEscape:D=!0,showCloseButton:k=!0})=>{i.useEffect(()=>{if(!e)return;const S=Q=>{D&&Q.key==="Escape"&&t()};return document.body.style.overflow="hidden",document.addEventListener("keydown",S),()=>{document.body.style.overflow="",document.removeEventListener("keydown",S)}},[e,D,t]);const K=()=>{d&&t()};return typeof window>"u"?null:Z.createPortal(r(p,{children:[n(ne,{$open:e,onClick:K,"aria-hidden":"true"}),r(se,{$open:e,$placement:s,$size:h,role:"dialog","aria-modal":"true","aria-labelledby":l?"drawer-title":void 0,children:[(l||k)&&r(de,{children:[l&&n(pe,{id:"drawer-title",children:l}),k&&n(ce,{onClick:t,"aria-label":"Close drawer",children:n(he,{})})]}),n(ue,{children:a}),u&&n(me,{children:u})]})]}),document.body)};try{o.displayName="Drawer",o.__docgenInfo={description:"",displayName:"Drawer",props:{open:{defaultValue:null,description:"Whether drawer is visible",name:"open",required:!0,type:{name:"boolean"}},onClose:{defaultValue:null,description:"Callback when drawer should close",name:"onClose",required:!0,type:{name:"() => void"}},children:{defaultValue:null,description:"Drawer content",name:"children",required:!0,type:{name:"ReactNode"}},placement:{defaultValue:{value:"right"},description:"Side from which drawer appears",name:"placement",required:!1,type:{name:"enum",value:[{value:'"left"'},{value:'"right"'},{value:'"top"'},{value:'"bottom"'}]}},size:{defaultValue:{value:"md"},description:"Drawer size",name:"size",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'},{value:'"full"'}]}},title:{defaultValue:null,description:"Drawer title",name:"title",required:!1,type:{name:"ReactNode"}},footer:{defaultValue:null,description:"Footer content",name:"footer",required:!1,type:{name:"ReactNode"}},closeOnOverlayClick:{defaultValue:{value:"true"},description:"Close on overlay click",name:"closeOnOverlayClick",required:!1,type:{name:"boolean"}},closeOnEscape:{defaultValue:{value:"true"},description:"Close on Escape key",name:"closeOnEscape",required:!1,type:{name:"boolean"}},showCloseButton:{defaultValue:{value:"true"},description:"Show close button",name:"showCloseButton",required:!1,type:{name:"boolean"}}}}}catch{}const Oe={title:"Components/Drawer",component:o,tags:["autodocs"]},b={render:()=>{const[e,t]=i.useState(!1);return r(p,{children:[n("button",{onClick:()=>t(!0),children:"Open Drawer"}),r(o,{open:e,onClose:()=>t(!1),title:"Drawer Title",children:[n("p",{children:"This is the drawer content. You can put any React elements here."}),n("p",{children:"Click the overlay or press Escape to close."})]})]})}},w={render:()=>{const[e,t]=i.useState(!1),[a,s]=i.useState(!1),[h,l]=i.useState(!1),[u,d]=i.useState(!1);return r("div",{style:{display:"flex",gap:"1rem",flexWrap:"wrap"},children:[n("button",{onClick:()=>t(!0),children:"Open Left"}),n("button",{onClick:()=>s(!0),children:"Open Right"}),n("button",{onClick:()=>l(!0),children:"Open Top"}),n("button",{onClick:()=>d(!0),children:"Open Bottom"}),n(o,{open:e,onClose:()=>t(!1),placement:"left",title:"Left Drawer",children:n("p",{children:"This drawer slides in from the left."})}),n(o,{open:a,onClose:()=>s(!1),placement:"right",title:"Right Drawer",children:n("p",{children:"This drawer slides in from the right."})}),n(o,{open:h,onClose:()=>l(!1),placement:"top",title:"Top Drawer",children:n("p",{children:"This drawer slides in from the top."})}),n(o,{open:u,onClose:()=>d(!1),placement:"bottom",title:"Bottom Drawer",children:n("p",{children:"This drawer slides in from the bottom."})})]})}},g={render:()=>{const[e,t]=i.useState(!1),[a,s]=i.useState(!1),[h,l]=i.useState(!1),[u,d]=i.useState(!1);return r("div",{style:{display:"flex",gap:"1rem",flexWrap:"wrap"},children:[n("button",{onClick:()=>t(!0),children:"Small (320px)"}),n("button",{onClick:()=>s(!0),children:"Medium (448px)"}),n("button",{onClick:()=>l(!0),children:"Large (640px)"}),n("button",{onClick:()=>d(!0),children:"Full Width"}),n(o,{open:e,onClose:()=>t(!1),size:"sm",title:"Small Drawer",children:n("p",{children:"This is a small drawer (320px wide)."})}),n(o,{open:a,onClose:()=>s(!1),size:"md",title:"Medium Drawer",children:n("p",{children:"This is a medium drawer (448px wide)."})}),n(o,{open:h,onClose:()=>l(!1),size:"lg",title:"Large Drawer",children:n("p",{children:"This is a large drawer (640px wide)."})}),n(o,{open:u,onClose:()=>d(!1),size:"full",title:"Full Width Drawer",children:n("p",{children:"This drawer takes up the full width of the screen."})})]})}},y={render:()=>{const[e,t]=i.useState(!1);return r(p,{children:[n("button",{onClick:()=>t(!0),children:"Open Drawer with Footer"}),r(o,{open:e,onClose:()=>t(!1),title:"Confirm Action",footer:r("div",{style:{display:"flex",gap:"0.5rem",justifyContent:"flex-end"},children:[n("button",{onClick:()=>t(!1),style:{padding:"0.5rem 1rem"},children:"Cancel"}),n("button",{onClick:()=>t(!1),style:{padding:"0.5rem 1rem",background:"#0284c7",color:"white",border:"none",borderRadius:"0.5rem"},children:"Confirm"})]}),children:[n("p",{children:"Are you sure you want to proceed with this action?"}),n("p",{children:"This cannot be undone."})]})]})}},O={render:()=>{const[e,t]=i.useState(!1);return r(p,{children:[n("button",{onClick:()=>t(!0),children:"Open Form Drawer"}),n(o,{open:e,onClose:()=>t(!1),title:"Create New User",footer:r("div",{style:{display:"flex",gap:"0.5rem",justifyContent:"flex-end"},children:[n("button",{onClick:()=>t(!1),children:"Cancel"}),n("button",{style:{background:"#0284c7",color:"white",border:"none",padding:"0.5rem 1rem",borderRadius:"0.5rem"},children:"Save"})]}),children:r("form",{style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[r("div",{children:[n("label",{style:{display:"block",marginBottom:"0.5rem",fontWeight:500},children:"Full Name"}),n("input",{type:"text",style:{width:"100%",padding:"0.5rem",borderRadius:"0.375rem",border:"1px solid #d1d5db"},placeholder:"John Doe"})]}),r("div",{children:[n("label",{style:{display:"block",marginBottom:"0.5rem",fontWeight:500},children:"Email"}),n("input",{type:"email",style:{width:"100%",padding:"0.5rem",borderRadius:"0.375rem",border:"1px solid #d1d5db"},placeholder:"john@example.com"})]}),r("div",{children:[n("label",{style:{display:"block",marginBottom:"0.5rem",fontWeight:500},children:"Role"}),r("select",{style:{width:"100%",padding:"0.5rem",borderRadius:"0.375rem",border:"1px solid #d1d5db"},children:[n("option",{children:"Admin"}),n("option",{children:"User"}),n("option",{children:"Guest"})]})]}),r("div",{children:[n("label",{style:{display:"block",marginBottom:"0.5rem",fontWeight:500},children:"Bio"}),n("textarea",{rows:4,style:{width:"100%",padding:"0.5rem",borderRadius:"0.375rem",border:"1px solid #d1d5db"},placeholder:"Tell us about yourself..."})]})]})})]})}},C={render:()=>{const[e,t]=i.useState(!1);return r(p,{children:[n("button",{onClick:()=>t(!0),children:"Open Drawer with Long Content"}),n(o,{open:e,onClose:()=>t(!1),title:"Terms and Conditions",children:r("div",{children:[n("h3",{children:"1. Introduction"}),n("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}),n("h3",{children:"2. User Agreement"}),n("p",{children:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}),n("h3",{children:"3. Privacy Policy"}),n("p",{children:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}),n("h3",{children:"4. Terms of Service"}),n("p",{children:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}),n("h3",{children:"5. Data Collection"}),n("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}),n("h3",{children:"6. User Rights"}),n("p",{children:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}),n("h3",{children:"7. Limitation of Liability"}),n("p",{children:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}),n("h3",{children:"8. Governing Law"}),n("p",{children:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."})]})})]})}},x={render:()=>{const[e,t]=i.useState(!1);return r(p,{children:[n("button",{onClick:()=>t(!0),children:"Open Drawer"}),n(o,{open:e,onClose:()=>t(!1),title:"No Close Button",showCloseButton:!1,children:n("p",{children:"This drawer has no close button. Click the overlay or press Escape to close."})})]})}},v={render:()=>{const[e,t]=i.useState(!1);return r(p,{children:[n("button",{onClick:()=>t(!0),children:"Open Drawer"}),r(o,{open:e,onClose:()=>t(!1),children:[n("h2",{style:{marginTop:0},children:"Custom Header"}),n("p",{children:"This drawer has no built-in title, but you can add your own header in the content."})]})]})}};var $,T,L;b.parameters={...b.parameters,docs:{...($=b.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {
...
}`,...(B=(q=w.parameters)==null?void 0:q.docs)==null?void 0:B.source}}};var W,z,F;g.parameters={...g.parameters,docs:{...(W=g.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => {
...
}`,...(F=(z=g.parameters)==null?void 0:z.docs)==null?void 0:F.source}}};var E,N,A;y.parameters={...y.parameters,docs:{...(E=y.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => {
    const [open, setOpen] = useState(false);
    return <>\r
