import{a as V,j as a}from"./jsx-runtime-c9381026.js";import{I as u}from"./Icon-e1e4d749.js";import{a as o}from"./styled-components.browser.esm-f7e1e14e.js";import"./index-8b3efc3f.js";import"./_commonjsHelpers-de833af9.js";const A=o.label`
  display: inline-flex; 
  align-items: center; 
  gap: 8px; 
...
`,N=o.span`
  ...
  color: #1a1a1a;
`,n=({label:e,checked:i,onChange:B,disabled:m=!1,indeterminate:h=!1,color:I="#3b82f6",size:c="md"})=>V(A,{$disabled:m,children:[a(w,{checked:i,onChange:j=>B(j.target.checked),disabled:m}),a(L,{$checked:i,$indeterminate:h,$color:I,$size:c,children:a(M,{$visible:h||i,$size:c,children:h?a(u,{name:"subtract",size:c}):a(u,{name:"check",size:c})})}),e&&a(N,{$size:c,children:e})]});try{n.displayName="CheckBox",n.__docgenInfo={description:"",displayName:"CheckBox",props:{label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"string"}},checked:{defaultValue:null,description:"",name:"checked",required:!0,type:{name:"boolean"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!0,type:{name:"(checked: boolean) => void"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean"}},indeterminate:{defaultValue:{value:"false"},description:"",name:"indeterminate",required:!1,type:{name:"boolean"}},color:{defaultValue:{value:"#3b82f6"},description:"",name:"color",required:!1,type:{name:"string"}},size:{defaultValue:{value:"md"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}}}}}catch{}const G={title:"Components/Checkbox",component:n,parameters:{layout:"centered"},tags:["autodocs"]},l={args:{label:"Accept terms and conditions",checked:!1,onChange:e=>console.log(e)}},r={args:{label:"Already accepted",checked:!0,onChange:e=>console.log(e)}},s={args:{label:"Select all",checked:!1,indeterminate:!0,onChange:e=>console.log(e)}},t={args:{label:"Disabled option",checked:!1,disabled:!0,onChange:e=>console.log(e)}},d={render:()=>V("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[a(n,{label:"Small checkbox",checked:!0,size:"sm",onChange:()=>{}}),a(n,{label:"Medium checkbox",checked:!0,size:"md",onChange:()=>{}}),a(n,{label:"Large checkbox",checked:!0,size:"lg",onChange:()=>{}})]})};var p,g,b;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    label: 'Accept terms and conditions',
    checked: false,
    onChange: checked => console.log(checked)
  }
}`,...(b=(g=l.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var k,x,f;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    label: 'Already accepted',
    checked: true,
    onChange: checked => console.log(checked)
  }
}`,...(f=(x=r.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var $,C,y;s.parameters={...s.parameters,docs:{...($=s.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    label: 'Select all',
    checked: false,
    indeterminate: true,
