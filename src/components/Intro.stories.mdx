...
```jsx
import "@landrik-ui/components/esm/styles/index.css";
```
...
```jsx
import "@landrik-ui/components/esm/styles/index.scss";
```
...
const getBabelPluginImportConfig = require('@landrik-ui/components/babel.plugin.import')
...
landrik-ui use `LocaleProvider` component to support localization.
...
import { LocaleProvider } from "@landrik-ui";
